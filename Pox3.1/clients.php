...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
    $stmt = $orders_pdo->prepare("INSERT INTO clients (full_name, email, phone, address, is_active) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([
        $_POST['full_name'],
        $_POST['email'],
        $_POST['phone'],
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    $stmt = $orders_pdo->prepare("UPDATE clients SET full_name = ?, email = ?, phone = ?, address = ?, is_active = ? WHERE client_id = ?");
    $stmt->execute([
        $_POST['full_name'],
        $_POST['email'],
        $_POST['phone'],
...
if (isset($_GET['delete'])) {
    $stmt = $orders_pdo->prepare("DELETE FROM clients WHERE client_id = ?");
...
$clients = $orders_pdo->query("SELECT * FROM clients ORDER BY client_id DESC")->fetchAll();
?>
<!DOCTYPE html>
<html lang="ru">
<head>
